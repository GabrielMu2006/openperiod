...
export function GroupsDashboard() {
  ...
  useEffect(() => {
    fetch("/api/groups").then(async (response) => {
      ...
      setGroups(((await response.json()) as { groups: GroupDTO[] }).groups);
    }).catch((cause) => {
      setGroups([]);
