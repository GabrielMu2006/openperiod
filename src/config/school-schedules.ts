...
const A_CLASS_PRESETS: SchedulePreset[] = [
  ...
  variant: "冬季作息",
    ...
    // 深圳大学：14 小节制（每节 40 分钟，粤海/丽湖校区通用）。
    // 来源：官网《关于新学期上课注意事项的温馨提示》原文表格（www.szu.edu.cn，2020 秋与 2021 春两学期一致）。
    // 第 1-12 节官方逐节公布（第 11-12 节按 2×40 分钟拆分）；第 13-14 节为官方连排区间 20:30-21:45 的等分拆分。
    // 深大另实行夏令作息（约 5/1-9/30 下午推迟），以教务部「上课时间表」图片版为准，如不符请反馈。
    {
    id: "szu",
    school: "深圳大学",
    kind: "period",
    rows: [
      ...
      { period: 5, start: "11:45", end: "12:25" },
      { period: 6, start: "13:30", end: "14:10" },
      { period: 7, start: "14:15", end: "14:55" },
      { period: 8, start: "15:00", end: "15:40" },
      { period: 9, start: "16:00", end: "16:40" },
      { period: 10, start: "16:45", end: "17:25" },
      { period: 11, start: "19:00", end: "19:40" },
      { period: 12, start: "19:40", end: "20:20" },
      { period: 13, start: "20:30", end: "21:05" },
      { period: 14, start: "21:10", end: "21:45" },
    ],
  },
    // 上海财经大学：14 小节制（每节 45 分钟）。
    // 来源：教务系统 EAMS 课表页表头实测映射（github.com/haohaoo3o/shufe-calendar-ics，2026-08），
    // 与校官网多篇开学新闻（下午第一节 13:20 开始）交叉吻合。第 10-11 节之间无间隔（官方表头即如此）。
    {
    id: "sufe",
    school: "上海财经大学",
    kind: "period",
    rows: [
      ...
      { period: 5, start: "11:55", end: "12:40" },
      { period: 6, start: "13:20", end: "14:05" },
      { period: 7, start: "14:15", end: "15:00" },
      { period: 8, start: "15:25", end: "16:10" },
      { period: 9, start: "16:20", end: "17:05" },
      ...
      { period: 12, start: "18:55", end: "19:40" },
      { period: 13, start: "19:50", end: "20:35" },
      { period: 14, start: "20:45", end: "21:30" },
    ],
  },
    // 中央财经大学：13 小节制（每节 45 分钟，与校网络教学平台「一节课 45 分钟」说明一致）。
    // 来源：课历适配器内置作息，溯源校发〔2019〕5 号校级文件（2026-09 人工核对）；
    // 教务处无公开逐节网页，沙河/学院南路通用性建议让学生核对一次，如不符请反馈。
    {
    id: "cufe",
    school: "中央财经大学",
    kind: "period",
    rows: [
      ...
      { period: 9, start: "16:00", end: "16:45" },
      { period: 10, start: "16:55", end: "17:40" },
      { period: 11, start: "17:50", end: "18:35" },
      { period: 12, start: "19:20", end: "20:05" },
      { period: 13, start: "20:15", end: "21:00" },
    ],
  },
    // 西南财经大学：12 小节制（每节 45 分钟，柳林/光华校区统一）。
    // 来源：教务处官网《教学作息时间安排表》（jwc.swufe.edu.cn，2014-09 发布）图片 OCR，
    // 与豆丁转载、知乎问答摘要三方逐字一致。
    {
    id: "swufe",
    school: "西南财经大学",
    ...
    rows: [
      ...
      { period: 9, start: "16:40", end: "17:25" },
      { period: 10, start: "18:30", end: "19:15" },
      { period: 11, start: "19:25", end: "20:10" },
      { period: 12, start: "20:20", end: "21:05" },
    ],
  },
    // 华北电力大学：10 小节制（北京校部与保定校区官方口径统一，每节 45 分钟）。
    // 来源：教务处官网「教务服务·作息时间」（jwc.ncepu.edu.cn）与研究生院作息页双源逐项一致。
    {
    id: "ncepu",
    school: "华北电力大学",
    kind: "period",
    ...
    // 南京师范大学：12 小节制（每节 40 分钟，仙林/随园/紫金校区统一）。
    // 来源：教务处官网《南京师范大学作息时间表》与拾光课程表适配器（github.com/kuailiaojie/classtable
    // NJNU）+ 教科院 2026 方案多源一致。中北学院（独立学院）作息不同，不适用本表。
    {
    id: "njnu",
    school: "南京师范大学",
    kind: "period",
    rows: [
      ...
      { period: 3, start: "09:40", end: "10:20" },
      { period: 4, start: "10:35", end: "11:15" },
      { period: 5, start: "11:20", end: "12:00" },
      { period: 6, start: "13:30", end: "14:10" },
      { period: 7, start: "14:15", end: "14:55" },
      { period: 8, start: "15:10", end: "15:50" },
      { period: 9, start: "15:55", end: "16:35" },
      { period: 10, start: "18:30", end: "19:10" },
      { period: 11, start: "19:20", end: "20:00" },
      { period: 12, start: "20:10", end: "20:50" },
    ],
  },
    // 华南师范大学：10 小节制（石牌/滨海汕尾校区，每节 40 分钟，上午 8:30 起）。
    // 来源：官方《上课作息时间表.doc》（pd.scnu.edu.cn）+ 开源课表应用内置官方作息交叉一致。
    // 大学城校区下午为 14:00-14:40 / 14:50-15:30 / 15:40-16:20 / 16:30-17:10；
    // 南海校区上午 8:15 起、晚上 19:40 起。以上校区用户如不符请反馈或用自定义作息。
    {
    id: "scnu",
    school: "华南师范大学",
    variant: "石牌校区",
    ...
    rows: [
      ...
      { period: 9, start: "19:00", end: "19:40" },
      { period: 10, start: "19:50", end: "20:30" },
    ],
  },
    // 湖南师范大学：13 小节制（每节 45 分钟；第 5 节 12:45 即开为教务系统特殊排版，与第 6 节无间隔）。
    // 来源：拾光课程表适配器 HUNNU 预设（适配强智教务系统）；晚间第 11-13 节 19:00-21:35
    // 经教务处 2025-09 通识选修课通知独立佐证。
    {
    id: "hunnu",
    school: "湖南师范大学",
    kind: "period",
    rows: [
      ...
      { period: 8, start: "15:25", end: "16:10" },
      { period: 9, start: "16:30", end: "17:15" },
      { period: 10, start: "17:25", end: "18:10" },
      { period: 11, start: "19:00", end: "19:45" },
      { period: 12, start: "19:55", end: "20:40" },
      { period: 13, start: "20:50", end: "21:35" },
    ],
  },
    // 安徽大学：13 小节制（磬苑校区等全校统一，每节 45 分钟）。
    // 来源：两个独立校园应用（AHU-AIO、Ahu_Plus）内置节次完全一致，均声明与教务处默认布局对齐。
    {
    id: "ahu",
    school: "安徽大学",
    kind: "period",
    ...
    // 西北农林科技大学：11 小节制，冬夏令两套（1-4 节相同，下午/晚上按季节切换）。
    // 来源：南大课表开源项目 schoolList（NWAFU 预设，逐年维护季节切换）+ NapTable 双源一致，
    // 并经西农学生开发的飞书工具佐证；晚间节次存在 11 节制与 12 节制两种口径，如不符请反馈。
    {
    id: "nwafu-winter",
    school: "西北农林科技大学",
    variant: "冬令作息（10/1–4/30）",
    kind: "period",
    rows: [
      { period: 1, start: "08:00", end: "08:45" },
      { period: 2, start: "08:55", end: "09:40" },
      ...
      { period: 9, start: "19:00", end: "19:45" },
      { period: 10, start: "19:50", end: "20:35" },
      { period: 11, start: "20:40", end: "21:35" },
    ],
  },
    {
    id: "nwafu-summer",
    school: "西北农林科技大学",
    variant: "夏令作息（5/1–9/30）",
    kind: "period",
    rows: [
      { period: 1, start: "08:00", end: "08:45" },
      { period: 2, start: "08:55", end: "09:40" },
    ...
    // ── 批量收录（2026-09）：以下 39 所来自社区课表适配数据汇总（拾光课程表 shiguang_warehouse /
    // AirCourse / 小爱课程表 AiSchedule 等适配仓库，项目所有者整理提供）。单一社区来源、未与官方
    // 逐节核验，可能对应特定校区/学期/历史版本；如与实际不符请在「课表信息」页反馈或改用自定义作息。
    // 中国科学院大学（社区适配数据，见下方批次说明）
    {
    id: "ucas",
    school: "中国科学院大学",
    kind: "period",
    rows: [
      ...
      { period: 7, start: "15:25", end: "16:10" },
      { period: 8, start: "16:15", end: "17:00" },
      { period: 9, start: "17:05", end: "17:50" },
      { period: 10, start: "18:30", end: "19:15" },
      { period: 11, start: "19:20", end: "20:05" },
      { period: 12, start: "20:15", end: "21:00" },
      { period: 13, start: "21:05", end: "21:50" },
    ],
  },
    // 海南大学（社区适配数据，见下方批次说明）
    {
    ...
    rows: [
      ...
      { period: 5, start: "14:30", end: "15:15" },
      { period: 6, start: "15:25", end: "16:10" },
      { period: 7, start: "16:35", end: "17:20" },
      { period: 8, start: "17:30", end: "18:15" },
      { period: 9, start: "19:20", end: "20:05" },
      { period: 10, start: "20:15", end: "21:00" },
      { period: 11, start: "21:10", end: "21:55" },
    ],
  },
    // 贵州大学（社区适配数据，见下方批次说明）
    ...
    rows: [
      ...
      { period: 10, start: "20:30", end: "21:20" },
      { period: 11, start: "21:30", end: "22:20" },
    ],
  },
    // 大连大学（社区适配数据，见下方批次说明）
    {
    ...
    rows: [
      ...
      { period: 6, start: "14:05", end: "14:50" },
      { period: 7, start: "15:05", end: "15:50" },
      { period: 8, start: "15:55", end: "16:40" },
      { period: 9, start: "16:55", end: "17:40" },
      { period: 10, start: "17:45", end: "18:30" },
    ],
  },
    // 闽南科技学院（社区适配数据，见下方批次说明）
    {
    id: "mnsk",
    school: "闽南科技学院",
    kind: "period",
    ...
    rows: [
      ...
      { period: 5, start: "14:00", end: "14:45" },
      { period: 6, start: "14:50", end: "15:35" },
      { period: 7, start: "16:05", end: "16:50" },
      { period: 8, start: "16:55", end: "17:40" },
    ...
    rows: [
      ...
      { period: 10, start: "19:00", end: "19:45" },
      { period: 11, start: "19:50", end: "20:35" },
      { period: 12, start: "20:40", end: "21:25" },
    ],
  },
    // 扬州大学（社区适配数据，见下方批次说明）
    {
    ...
    rows: [
      ...
      { period: 7, start: "15:25", end: "16:10" },
      { period: 8, start: "16:20", end: "17:05" },
      { period: 9, start: "17:15", end: "18:00" },
      { period: 10, start: "18:10", end: "18:55" },
      { period: 11, start: "19:30", end: "20:15" },
      { period: 12, start: "20:25", end: "21:10" },
    ],
  },
    // 江西师范大学（社区适配数据，见下方批次说明）
    {
    id: "jxnu",
    school: "江西师范大学",
    kind: "period",
    ...
    // 马鞍山学院（社区适配数据，见下方批次说明）
    {
    id: "masu",
    school: "马鞍山学院",
    kind: "period",
    rows: [
      { period: 1, start: "08:20", end: "09:05" },
      { period: 2, start: "09:10", end: "09:55" },
      { period: 3, start: "10:15", end: "11:00" },
      { period: 4, start: "11:05", end: "11:50" },
      { period: 5, start: "13:50", end: "14:35" },
      ...
      { period: 9, start: "18:20", end: "19:05" },
      { period: 10, start: "19:10", end: "19:55" },
      { period: 11, start: "20:00", end: "20:45" },
    ],
  },
    // 桂林医科大学（社区适配数据，见下方批次说明）
    {
    id: "glmc",
    school: "桂林医科大学",
    kind: "period",
    ...
    rows: [
      ...
      { period: 6, start: "14:30", end: "15:10" },
      { period: 7, start: "15:20", end: "16:00" },
      { period: 8, start: "16:20", end: "17:00" },
      { period: 9, start: "17:10", end: "17:50" },
      { period: 10, start: "18:00", end: "18:40" },
      { period: 11, start: "19:30", end: "20:10" },
      { period: 12, start: "20:20", end: "21:00" },
    ],
  },
    // 山东师范大学（社区适配数据，见下方批次说明）
    {
    id: "sdnu",
    school: "山东师范大学",
    kind: "period",
    rows: [
      ...
      { period: 6, start: "14:50", end: "15:35" },
      { period: 7, start: "15:50", end: "16:35" },
      { period: 8, start: "16:40", end: "17:25" },
      { period: 9, start: "19:00", end: "19:45" },
      { period: 10, start: "19:50", end: "20:35" },
      { period: 11, start: "20:40", end: "21:25" },
      { period: 12, start: "21:30", end: "22:15" },
    ],
  },
    // 福建农林大学（社区适配数据，见下方批次说明）
    {
    id: "fafu",
    school: "福建农林大学",
    kind: "period",
    rows: [
      ...
      { period: 8, start: "15:50", end: "16:35" },
      { period: 9, start: "16:40", end: "17:25" },
      { period: 10, start: "18:25", end: "19:10" },
      { period: 11, start: "19:15", end: "20:00" },
      { period: 12, start: "20:05", end: "20:50" },
    ],
  },
    // 南京工业职业技术大学（社区适配数据，见下方批次说明）
    {
    id: "niit",
    school: "南京工业职业技术大学",
    kind: "period",
    rows: [
      ...
      { period: 7, start: "15:30", end: "16:15" },
      { period: 8, start: "16:25", end: "17:10" },
      { period: 9, start: "18:15", end: "19:00" },
      { period: 10, start: "19:10", end: "19:55" },
      { period: 11, start: "20:05", end: "20:50" },
    ],
  },
    // 武汉科技大学（社区适配数据，见下方批次说明）
    {
    id: "wust",
    school: "武汉科技大学",
    kind: "period",
    rows: [
      ...
      { period: 8, start: "16:55", end: "17:40" },
      { period: 9, start: "18:40", end: "19:25" },
      { period: 10, start: "19:35", end: "20:20" },
      { period: 11, start: "20:40", end: "21:25" },
      { period: 12, start: "21:35", end: "22:20" },
    ],
  },
    // 绵阳师范学院（社区适配数据，见下方批次说明）
    {
    id: "mnu",
    school: "绵阳师范学院",
    kind: "period",
    ...
    rows: [
      ...
      { period: 8, start: "15:50", end: "16:30" },
      { period: 9, start: "16:40", end: "17:20" },
      { period: 10, start: "18:30", end: "19:10" },
      { period: 11, start: "19:20", end: "20:00" },
      { period: 12, start: "20:10", end: "20:50" },
      { period: 13, start: "21:00", end: "21:40" },
    ],
  },
    // 河北经贸大学（社区适配数据，见下方批次说明）
    {
    id: "hbjm",
    school: "河北经贸大学",
    kind: "period",
    rows: [
      ...
      { period: 10, start: "17:25", end: "18:10" },
      { period: 11, start: "19:00", end: "19:45" },
      { period: 12, start: "19:45", end: "20:30" },
      { period: 13, start: "20:40", end: "21:25" },
    ],
  },
    // 常州大学（社区适配数据，见下方批次说明）
    ...
    rows: [
      ...
      { period: 6, start: "13:30", end: "14:10" },
      { period: 7, start: "14:15", end: "14:55" },
      { period: 8, start: "15:15", end: "15:55" },
      { period: 9, start: "16:00", end: "16:40" },
      { period: 10, start: "18:30", end: "19:10" },
      { period: 11, start: "19:15", end: "19:55" },
      { period: 12, start: "20:05", end: "20:45" },
    ],
  },
    // 中国计量大学（社区适配数据，见下方批次说明）
    {
    id: "cjlu",
    school: "中国计量大学",
    kind: "period",
    rows: [
      ...
      { period: 11, start: "18:50", end: "19:35" },
      { period: 12, start: "19:40", end: "20:25" },
      { period: 13, start: "20:35", end: "21:20" },
    ],
  },
    // 广西医科大学（社区适配数据，见下方批次说明）
    {
    id: "gxmu",
    school: "广西医科大学",
    kind: "period",
    rows: [
      { period: 1, start: "08:20", end: "09:00" },
      { period: 2, start: "09:05", end: "09:45" },
      { period: 3, start: "10:05", end: "10:45" },
      { period: 4, start: "10:50", end: "11:30" },
      { period: 5, start: "11:35", end: "12:15" },
      { period: 6, start: "14:30", end: "15:10" },
      { period: 7, start: "15:15", end: "15:55" },
      { period: 8, start: "16:15", end: "16:55" },
      { period: 9, start: "17:00", end: "17:40" },
      { period: 10, start: "19:00", end: "19:40" },
      { period: 11, start: "19:45", end: "20:25" },
      { period: 12, start: "20:30", end: "21:10" },
    ],
  },
    // 三峡大学（社区适配数据，见下方批次说明）
    {
    ...
    rows: [
      ...
      { period: 8, start: "17:15", end: "18:00" },
      { period: 9, start: "19:30", end: "20:15" },
      { period: 10, start: "20:25", end: "21:10" },
    ],
  },
    // 天津农学院（社区适配数据，见下方批次说明）
    {
    id: "tjau",
    school: "天津农学院",
    kind: "period",
    ...
    rows: [
      ...
      { period: 6, start: "14:40", end: "15:25" },
      { period: 7, start: "15:30", end: "16:15" },
      { period: 8, start: "16:30", end: "17:15" },
      { period: 9, start: "17:20", end: "18:05" },
      { period: 10, start: "18:30", end: "19:15" },
      { period: 11, start: "19:20", end: "20:05" },
      { period: 12, start: "20:10", end: "20:55" },
      { period: 13, start: "21:00", end: "21:45" },
      { period: 14, start: "21:50", end: "22:35" },
    ],
  },
    // 泰山学院（社区适配数据，见下方批次说明）
    {
    ...
    rows: [
      ...
      { period: 9, start: "19:30", end: "20:20" },
      { period: 10, start: "20:20", end: "21:10" },
    ],
  },
    // 华侨大学（社区适配数据，见下方批次说明）
    {
    ...
    rows: [
      ...
      { period: 8, start: "16:20", end: "17:05" },
      { period: 9, start: "17:15", end: "18:00" },
      { period: 10, start: "18:20", end: "19:05" },
    ...
    rows: [
      ...
      { period: 7, start: "14:55", end: "15:40" },
      { period: 8, start: "15:45", end: "16:30" },
      { period: 9, start: "17:30", end: "18:15" },
      { period: 10, start: "18:20", end: "19:05" },
      { period: 11, start: "19:25", end: "20:10" },
      { period: 12, start: "20:15", end: "21:00" },
    ],
  },
    // 南阳理工学院（社区适配数据，见下方批次说明）
    {
    id: "nyist",
    school: "南阳理工学院",
    kind: "period",
    ...
    rows: [
      ...
      { period: 7, start: "16:10", end: "17:00" },
      { period: 8, start: "17:10", end: "17:50" },
      { period: 9, start: "18:00", end: "18:50" },
      { period: 10, start: "19:00", end: "19:50" },
    ],
  },
    ...
    rows: [
      ...
      { period: 7, start: "14:50", end: "15:35" },
      { period: 8, start: "15:35", end: "16:20" },
      { period: 9, start: "16:20", end: "17:05" },
      { period: 10, start: "18:00", end: "18:45" },
    ...
    rows: [
      ...
      { period: 7, start: "16:20", end: "17:05" },
      { period: 8, start: "17:05", end: "17:50" },
      { period: 9, start: "18:50", end: "19:35" },
      { period: 10, start: "19:45", end: "20:30" },
      { period: 11, start: "20:40", end: "21:25" },
      { period: 12, start: "21:35", end: "22:20" },
    ],
  },
    // 西安石油大学（社区适配数据，见下方批次说明）
    {
    id: "xsyu",
    school: "西安石油大学",
    kind: "period",
    ...
    rows: [
      ...
      { period: 4, start: "10:40", end: "11:20" },
      { period: 5, start: "11:25", end: "12:05" },
      { period: 6, start: "12:40", end: "13:20" },
      { period: 7, start: "13:25", end: "14:05" },
      { period: 8, start: "14:30", end: "15:10" },
      { period: 9, start: "15:15", end: "15:55" },
      { period: 10, start: "16:25", end: "17:05" },
      { period: 11, start: "17:10", end: "17:50" },
      { period: 12, start: "17:55", end: "18:35" },
      { period: 13, start: "19:30", end: "20:10" },
      { period: 14, start: "20:15", end: "20:55" },
      { period: 15, start: "21:00", end: "21:40" },
    ],
  },
];
