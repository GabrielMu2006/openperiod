...
export async function sendVerificationMail(to: string, code: string, purpose: ChallengePurpose) {
  const action = { REGISTER: "注册账号", SET_PASSWORD: "首次设置密码", RESET_PASSWORD: "重置密码" }[purpose];
